...
const Game = ({ isMuted, toggleMusicMute }) => {
  ...
  return (
    <div className="h-screen overflow-hidden flex md:items-center justify-center">
      <div>
 <div className="md:scale-50 lg:scale-75 h-[400px] w-[700px] md:h-[700px] md:w-[1500px] items-center mb-10 md:mb-0 border border-white bg-cover bg-no-repeat2"
      ...
      {isModalOpen && (
        <div className="flex justify-center">
          ...
          <div className=" text-center z-50">
            ...
            <div className={`flex flex-col items-center justify-center relative bottom-8 md:bottom-40 lg:bottom-20 ${isSelectionVisible || isModalOpen || isPlayerHurt || isPlayerShooting || isComputerHurt || isComputerShooting  || isGameOver ? 'brightness-0' : ''}`}>     
      ...
      <a href="https://www.linkedin.com/in/fabi%C3%A1n-musicco-a164231b4/" target="_blank" rel="noopener noreferrer">
      <button className="cursor-pointer">
    <img src={linkedin} alt="Linkedin button" className="w-10 h-10" />
  </button>
  </a>

  <a href="https://github.com/vlas-dev" target="_blank" rel="noopener noreferrer">
  <button className="cursor-pointer">
  ...
  <button className="cursor-pointer">
    <img src={mail} alt="Email button" className="w-10 h-10 relative bottom-1 lg:bottom-auto" 
    onClick={() => {
      copyEmail();
